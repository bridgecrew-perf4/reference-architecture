resource "aws_wafv2_web_acl" "waf_regional" {
  name        = local.waf_regional_prefix
  description = "${local.waf_regional_prefix} Region-specific Terraform managed WAF with generic rules"
  scope       = "REGIONAL"
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.waf_regional_prefix}-aws-crs"
      sampled_requests_enabled   = false
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.waf_regional_prefix}-aws-sqli"
      sampled_requests_enabled   = false
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.waf_regional_prefix}-aws-lfi"
      sampled_requests_enabled   = false
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.waf_regional_prefix}-aws-linux-shell"
      sampled_requests_enabled   = false
    }
  }
  ...
  #  visibility_config {
  #    cloudwatch_metrics_enabled = true
  #    metric_name                = "${local.waf_regional_prefix}-aws-powershell"
  #    sampled_requests_enabled   = false
  #  }
  #}
  ...
  #  visibility_config {
  #    cloudwatch_metrics_enabled = true
  #    metric_name                = "${local.waf_regional_prefix}-aws-php"
  #    sampled_requests_enabled   = false
  #  }
  #}
  ...
  #  visibility_config {
  #    cloudwatch_metrics_enabled = true
  #    metric_name                = "${local.waf_regional_prefix}-aws-wordpress"
  #    sampled_requests_enabled   = false
  #  }
  #}
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.waf_regional_prefix}-aws-ip-reputation"
      sampled_requests_enabled   = false
    }
  }
  ...
  #  visibility_config {
  #    cloudwatch_metrics_enabled = true
  #    metric_name                = "${local.waf_regional_prefix}-aws-ip-anonymous"
  #    sampled_requests_enabled   = false
  #  }
  #}
...
resource "aws_wafv2_web_acl_logging_configuration" "waf_regional" {
  log_destination_configs = [aws_kinesis_firehose_delivery_stream.waf_log_stream_regional.arn]
